...
public class MainDashboardController implements Initializable {
    ...
    @FXML
    private void OfferAcourseOnClick(ActionEvent event) throws IOException {
        Parent parent = FXMLLoader.load(getClass().getResource("OfferNewCourse.fxml"));
        DashboardBorderPane.setCenter(parent);
    }
    ...
    @FXML
    private void DistributionReportOnCLick(ActionEvent event) throws IOException {
        Parent parent = FXMLLoader.load(getClass().getResource("ViewFacultyCount.fxml"));
        DashboardBorderPane.setCenter(parent);
    }
    @FXML
    private void DistributionRatioChartOnCLick(ActionEvent event) throws IOException {
        Parent parent = FXMLLoader.load(getClass().getResource("PieChartFacultyDistribution.fxml"));
        DashboardBorderPane.setCenter(parent);
    }
}
